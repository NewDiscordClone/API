...
{
    public class JoinServerCommandHandler : RequestHandlerBase, IRequestHandler<JoinServerCommand>
    {
        ...
        public async Task Handle(JoinServerCommand command, CancellationToken cancellationToken)
        {
