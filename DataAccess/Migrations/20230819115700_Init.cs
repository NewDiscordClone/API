    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatUser", x => new { x.PrivateChatsId, x.UsersId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatUser_Chats_PrivateChatsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServerProfilesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleServerProfile", x => new { x.RolesId, x.ServerProfilesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleServerProfile_ServerProfiles_ServerProfilesId",
                        column: x => x.ServerProfilesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleServerProfile_ServerProfilesId",
                table: "RoleServerProfile",
                column: "ServerProfilesId");
